...
function setup() {
  ...
  // sleep.addRecord(2021, 12, 2, 13, 18, 20, 28, false);
  // sleep.addRecord(2021, 12, 3, 12, 9, 20, 4, false);
  // sleep.addRecord(2021, 12, 4, 13, 2, 22, 50, false);
  // sleep.addRecord(2021, 12, 5, 13, 46, 0, 24, false);
  // sleep.addRecord(2021, 12, 6, 18, 26, 2, 29, false);
  // sleep.addRecord(2021, 12, 7, 20, 5, 4, 33, false);
  // sleep.addRecord(2021, 12, 8, 20, 12, 2, 2, false);
  // sleep.addRecord(2021, 12, 9, 19, 46, 4, 32, false);
  // sleep.addRecord(2021, 12, 10, 21, 45, 5, 32, false);
  // sleep.addRecord(2021, 12, 12, 22, 27, 7, 35, false);
